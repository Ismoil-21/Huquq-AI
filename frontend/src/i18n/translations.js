export const translations = {
  uz: {
    ...
    login_required_title: "AI maslahatdan foydalanish uchun kirish kerak",
    login_required_desc: "Ro'yxatdan o'ting yoki tizimga kiring — <strong>bepul</strong> va bir daqiqa vaqt oladi.",
    login_required_features: "✅ Kuniga <strong>20 ta</strong> bepul savol<br/>✅ Barcha suhbatlar saqlanadi<br/>✅ O'zbek, Rus, Ingliz tillarida<br/>✅ 24/7 ishlaydi",
    login_required_telegram: "Telegram bot orqali ham foydalanishingiz mumkin",
  ...
  ru: {
    ...
    login_required_title: "Для использования AI-консультации необходимо войти",
    login_required_desc: "Зарегистрируйтесь или войдите — это <strong>бесплатно</strong> и займёт минуту.",
    login_required_features: "✅ <strong>20 бесплатных</strong> вопросов в день<br/>✅ Все чаты сохраняются<br/>✅ На узбекском, русском и английском<br/>✅ Работает 24/7",
    login_required_telegram: "Также можно воспользоваться через Telegram бот",
  ...
  en: {
    ...
    login_required_title: "You need to sign in to use AI consultation",
    login_required_desc: "Register or sign in — it's <strong>free</strong> and takes a minute.",
    login_required_features: "✅ <strong>20 free</strong> questions per day<br/>✅ All chats are saved<br/>✅ In Uzbek, Russian and English<br/>✅ Available 24/7",
    login_required_telegram: "You can also use it through our Telegram bot",
    drawer_limit_reached: "⚠️ Daily limit reached ({n} questions). Come back tomorrow.",
    chat_image_size_error: "Image size must not exceed 5MB",
    chat_upload_image: "Upload image",
    telegram_saved_msg: "Username saved! Go to the bot and press /start.",
    telegram_username_label: "Telegram username",
    telegram_confirm: "Confirm",
  },
};
